...
<style>
   .banner-robots {
    ...
    .robo-2{
        background-image: url('@/assets/media/robots/robo2.jpg');
    }
    .robo-3{
        background-image: url('@/assets/media/robots/robo3.jpg');
    }
    .robo-4{
        background-image: url('@/assets/media/robots/robo4.jpg');
    }
</style>