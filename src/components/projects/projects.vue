<template>
    <section>
        ...
        <div class="grid grid-cols-2 grid-rows-2 px-12
        xs:max-xl:grid-cols-1 xs:max-xl:px-2">
            <div v-motion-slide-left :duration="1000" class="flex flex-col justify-between row-span-2 h-full my-auto rounded-2xl
                xs:max-md:flex-col xs:max-md:h-fit xs:max-md:w-11/12 xs:max-md:mx-auto">
                <div class="bg-[#e8e8e8] my-12 h-full rounded-2xl
                xs:max-xl:hidden">
                    <div id="carouselTeste" class="carousel slide carousel-fade h-fit border-2 xl:size-full rounded-2xl" data-bs-ride="carousel">
                        <div class="carousel-inner rounded-t-2xl">
                            <div class="carousel-item rounded-2xl active card-3 bg-center h-72" data-bs-interval="2500"></div>
                            <div class="carousel-item rounded-2xl card-2 bg-center h-72" data-bs-interval="2500"></div>
                            <div class="carousel-item rounded-2xl card-4 bg-center h-72" data-bs-interval="2500"></div>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col justify-between h-fit bg-[#e8e8e8] my-auto rounded-2xl hover:shadow-2xl duration-500 
                xs:max-md:flex-col xs:max-md:h-fit xs:max-md:w-11/12 xs:max-md:mx-auto">
                ...
                <!-- <div class="bg-[#e8e8e8] my-12 h-full rounded-2xl card-4 bg-center border border-[#e8e8e8]
                xs:max-xl:hidden"> -->
                <div class="bg-[#e8e8e8] my-12 h-full rounded-2xl
                xs:max-xl:hidden">
                    <div id="carouselTeste" class="carousel slide carousel-fade h-fit border-2 xl:size-full rounded-2xl" data-bs-ride="carousel">
            ...
            <div v-motion-slide-right :duration="1000" class="flex h-4/12 bg-[#e8e8e8] m-12 rounded-2xl hover:shadow-2xl duration-500
            flex-col xs:max-md:h-fit xs:max-md:w-11/12 xs:max-md:mx-auto">
                <div class="w-12/12 h-full md:rounded-t-xl card-2 bg-center
                xs:max-md:size-full xs:max-md:rounded-t-2xl xs:max-md:h-40 xs:max-md:bg-cover"></div>
                <div
                    ...
                    xl:max-2xl:text-sm">O Sistema de Proteção contra Descargas Atmosféricas (SPDA) é cuidadosamente
                        ...
                        eficaz. Essas características garantem uma proteção robusta contra raios, aumentando a segurança
            ...
            <div v-motion-slide-visible-once-right :duration="1000" class="flex h-10/12 bg-[#e8e8e8] m-12 rounded-2xl hover:shadow-2xl duration-500
             flex-col xs:max-md:h-fit xs:max-md:w-11/12 xs:max-md:mx-auto">

                <!-- <div class="w-12/12 h-full md:rounded-l-xl card-4 bg-center
                ...
                <div id="carouselLumi" class="carousel slide h-fit border-2 xl:size-full rounded-t-2xl"
                    ...
                    <div class="carousel-inner rounded-t-2xl">
                        <div class="carousel-item active" data-bs-interval="5000">
                            <img src="@/assets/media/projects/projeto 1.webp" class="d-block w-100 rounded-t-2xl"
                                alt="...">
                            <div class="carousel-caption d-none d-md-block text-white bg-black opacity-80">
                                <h5></h5>
                            </div>
                        ...
                        <div class="carousel-item" data-bs-interval="5000">
                            <img src="@/assets/media/projects/projeto 2.webp" class="d-block m-auto w-100 rounded-t-2xl"
                                alt="...">
                            <div class="carousel-caption d-none d-md-block text-white bg-black opacity-80">
                                <h5></h5>
                            </div>
                ...
                <div
                    ...
                    <p class="text-base 
                    xs:max-md:text-sm 
                    xl:max-2xl:text-sm">Na Luminotécnica, o dimensionamento de área, o cálculo de lumens e o cálculo de
                        ...
                        consumo de energia e melhorando a qualidade da iluminação. A conformidade com as normas técnicas
...
.card-4 {
    background-image: url('@/assets/media/projects/projeto 2.webp');
}
</style>