<template>
    <section class="mb-16">
        <div class="bg-[#777777] h-80 mb-16">banner</div>
    ...
    <section class="my-16">
        ...
        <div class="flex flex-row justify-evenly">
            <div class="border w-3/12 h-96 px-12 py-12 rounded-xl hover:shadow-2xl hover:scale-110 hover:-translate-y-1 duration-300">
