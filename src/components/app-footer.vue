<template>
    <div class="bg-[#131313]">
        <footer class="text-[#656567] p-24">
            <div class="grid grid-cols-3 h-36 w-12/12 mx-auto">
                <div class="border-r border-[#656567]">
                    <img src="../assets/logo zetta.png" alt="" class="h-16 mt-10 mr-6">
                </div>
                <div class="m-auto">
                    <div class="">
                        <h3>Onde estamos:</h3>
