<template>
    <div class="grid gap-4 grid-cols-1 grid-rows-3 place-content-evenly mt-24">
        ...
        <section class="grid gap-4 grid-cols-2 grid-rows-1 content-center m-auto pl-36 pr-36 pb-24">
            <div class="border-2 rounded-l-full">
                <p>imagem</p>
            </div>
            <div class="w-12/12 relative">
                <h3 class="text-6xl mb-6 pt-12">
    ...
    <section class="relative my-32 mx-32 py-9 flex bg-[#eaeaeb] rounded-xl hover:shadow-2xl hover:-translate-y-1 hover:scale-[1.03] duration-300">
        <span class="text-4xl m-auto">
        Gostou do que viu?<br>
        Solicite um orçamento, nossa equipe está ansiosa para trabalhar com você!
        </span>
        <button class="w-52 h-16 m-auto text-xl bg-gradient-to-br from-[#00daf3] to-[#00b7cb] rounded-lg hover:shadow-2xl duration-300">
            <router-link />Solicitar orçamento
        </button>
    </section>
</template>
<script>
